...
export default function RanpoSprite() {
  ...
  return (
    <div
      className="relative aspect-square w-32 shrink-0 cursor-default bg-size-[400%_200%] bg-no-repeat drop-shadow-[0_0_8px_rgba(0,0,0,0.2)] transition-transform duration-300 ease-out contain-[paint] hover:scale-103 hover:rotate-1 md:w-54"
